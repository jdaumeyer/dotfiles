...
(def-doom-theme apollo
  "A nice org aware dark mode for emacs"
  ((bg '("#2a2929" "black" "black"))
   (bg-alt '("#151514" "black" "gray") )
   (fg '("#e4e4e5" "white" "white"))
   (fg-alt '("#655c5a" "lightgray" "gray"))
  ...
  ((cursor :background grey)
   ...
   ;; Org Mode faces
   (org-document-title :foreground fg :height 3.0 :weight 'extra-bold)
   (org-level-1 :foreground fg       :height 1.8 :weight 'extra-bold)
   (org-level-2 :foreground violet   :height 1.6 :weight 'extra-bold)
   (org-level-3 :foreground teal     :height 1.4 :weight 'extra-bold)
   (org-level-4 :foreground green    :height 1.2 :weight 'extra-bold)
   (org-level-5 :foreground blue     :height 1.1 :weight 'extra-bold)
   (org-level-6 :foreground violet   :height 1.1 :weight 'extra-bold)
   (org-level-7 :foreground orange   :height 1.0 :weight 'extra-bold)
   (org-level-8 :foreground green    :height 1.0 :weight 'extra-bold)
